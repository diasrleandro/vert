...
<body class="seo_version">
    ...
    $qtd = $res->num_rows;
    print $qtd;
    //$textos = $res->fetch_assoc();


    // Supondo que $res é o resultado da consulta
    $results = [];
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbars-seo">
					<ul class="navbar-nav ml-auto">
						...
						<!-- <li style=" list-style: none;" class="nav-item dropdown">
>>>>>>> 8a4718e9f7271dd68992abd5d4032d1343d465ee
        ...
        <div class="container">
            ...
            <div class="section-title text-center divProdutosTitulo">
                <h3 class="text-color-bordo"> <?php
                                                echo $results[11]['content1'];
                                                ?></h3>
                <h5 class="lead"> <?php
                                    echo $results[11]['content2'];
                                    ?></h5>
            </div><!-- end title -->
            ...
            <div class="seo-services row clearfix ">
                ...
                <div class="col-md-6 col-xs-12">
                    <div class="why-dit ">
                        ...
                        <div class="divValores">
                            <p><?php
                                echo $results[6]['content2'];
                                ?></p>
                        </div>
                        <div class="divValores">
                            <p><?php
                                echo $results[7]['content2'];
                                ?></p>
                        </div>
                        <div class="divValores">
                            <p><?php
                                echo $results[8]['content2'];
                                ?></p>
                        </div>
                        <div class="divValores">
                            <p><?php
                                echo $results[9]['content2'];
                                ?></p>
                        </div>
                    </div>
                </div><!-- end col -->
                ...
                <div class="owl-services-seo  owl-carousel owl-theme">
                    ...
                    <div>
                        <div class="service-widget divProdutosServicos " style="margin-left: 100px;">
                            <div class="post-media wow fadeIn">
                                <h3> <?php
                                        echo $results[15]['content1'];
                                        ?>
                                </h3>
                            </div>
                            <?php
                            echo $results[15]['content2'];
                            ?>
