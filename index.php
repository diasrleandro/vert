		...
		<div class="sl-slider">
			...
			<div class="sl-slide" data-orientation="horizontal" data-slice1-rotation="-25" data-slice2-rotation="-25" data-slice1-scale="2" data-slice2-scale="2">
				<div class="sl-slide-inner">
					...
					<h2><?php $textos[0] . ['content2']; ?></h2>
					<blockquote>
						<p> <?php $textos[0] . ['content2']; ?> </p>
			...
			<div class="row">
				<div class="col-md-6 m40">
					<div class="message-box divNossaEmpresa">
						<h4><?php $textos[4] . ['title']; ?></h4>
						<h2 class="text-color-bordo"> <?php $textos[5] . ['content2']; ?> </h2>
			...
			<div style="display: none;" class="row vission-and-mission">
				<div class="col-md-12">
					<ul class="nav nav-pills nav-justified" id="myTab" role="tablist">
						<li class="nav-item" style=" list-style: none;"><a class="nav-link active" href="#tab_a" data-toggle="tab">Missão</a></li>
						<li class="nav-item" style=" list-style: none;"><a class="nav-link" href="#tab_b" data-toggle="tab">Valores</a></li>
					</ul>
			...
			<div class="seo-services row clearfix ">
				...
				<div class="col-md-6 col-xs-12">
					<div class="why-dit ">
						...
						<div class="divValores">
							<p><?php $textos[6] . ['content2']; ?></p>
						</div>
						<div class="divValores">
							<p><?php $textos[7] . ['content2']; ?></p>
						</div>
						<div class="divValores">
							<p><?php $textos[8] . ['content2']; ?></p>
						</div>
					</div>
				</div><!-- end col -->
				...
				<div class="col-md-6 col-xs-12 divProdutosDestaque ">
					<div class="why-dit">
						<h4 class="text-color-bordo"><?php $textos[13] . ['title']; ?> </h4>
						<h5><?php $textos[123] . ['content1']; ?></h5>
						<p><?php $textos[12] . ['content2']; ?></p>
					</div>
				</div><!-- end col -->
		...
		<div class="container-fluid">
			<div class="container">
				<div class="section-title text-center divProdutosServicosTitulo">
					<h3><?php $textos[13] . ['content1']; ?></h3>
					<p class="lead"><?php $textos[13] . ['content2']; ?></p>
				</div><!-- end title -->
			</div>
				...
				<div class="owl-services-seo  owl-carousel owl-theme">
					<div>
						<div class="service-widget divProdutosServicos " style="margin-left: 100px;">
							<div class="post-media wow fadeIn">
								<h3><?php $textos[14] . ['content1']; ?> </h3>
							</div>
							<p><?php $textos[14] . ['content2']; ?></p>
						</div><!-- end service -->
					</div><!-- end col -->
					...
					<div>
						<div class="service-widget divProdutosServicos ">
							<div class="post-media wow fadeIn">
								<h3><?php $textos[15] . ['content1']; ?> </h3>
							</div>
							<p><?php $textos[15] . ['content2']; ?></p>
						</div><!-- end service -->
					</div><!-- end col -->
								...
								<div class="form-group">
									...
									<button type="submit">
										<svg id="Layer_11" data-name="Layer 11" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 25.19 17.71">
											<path class="cls-1" d="M311,387.93a.89.89,0,0,0-1.27,1.26l6.44,6.44H295a.89.89,0,0,0-.89.89.9.9,0,0,0,.89.9h21.24l-6.44,6.42a.91.91,0,0,0,0,1.27.89.89,0,0,0,1.27,0l8-8a.87.87,0,0,0,0-1.25Z" transform="translate(-294.08 -387.67)"></path>
										</svg>
									</button>
								</div>
							</form>
